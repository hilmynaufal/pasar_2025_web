                                ...
                                <div class="grid-margin">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3 mb-3">
                                            ...
                                            <select class="form-control form-control-sm" id="filter_distrik"
                                                wire:model="filter_distrik">
...
<script>
    document.addEventListener('livewire:navigated', function () {
        ...
        function updateTable() {
            ...
            $.ajax({
                "url": "{{ env('APP_URL') }}/laporan_transaksi",
                "method": "POST",
                "timeout": 0,
                "data": filterData
        ...
        function updateFilterOptions() {
            ...
            $.ajax({
                "url": "{{ env('APP_URL') }}/filter_options",
                "method": "POST",
                "timeout": 0,
                "data": filterData
            }).done(function (response) {
        ...
        $(document).on('change', '#filter_distrik', function () {
